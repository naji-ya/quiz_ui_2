...
import 'package:flutter_quiz_2/pages/MusicQuiz/classes/music_question_class.dart';
...
MusicQBank musicqbank = MusicQBank();
...
class _MusicPageState extends State<MusicPage> {
  int selecteddMusicOptionIndex = -1;
  bool answerSelected = false;
  int musicScore = 0;

  void setMusicAnswer() {
    if (selecteddMusicOptionIndex == musicqbank.getMusicCorrectAnswerIndex()) {
      setState(() {
        musicScore++;
      });
    }
  ...
  void onPreviousButtonPressed() {
    musicqbank.goToPreviousQuestion();
    setState(() {
      showPreviousButton = musicqbank.musicQuestionNumber > 0;
    });
  }
      ...
      body: Column(
        children: [
          ...
          ListView.builder(
              ...
              itemCount: musicqbank.getMusicOptions().length,
              itemBuilder: (BuildContext context, int index) {
                bool isSelected = selecteddMusicOptionIndex == index;
                bool isCorrect =
                    musicqbank.getMusicCorrectAnswerIndex() == index;
                ...
                */
                ...
                return GestureDetector(
                  onTap: () {
                    setState(() {
                      selecteddMusicOptionIndex = index;
                    ...
                    child: Container(
                      ...
                      child: Padding(
                        ...
                        child: Text(
                          ...
                          musicqbank.getMusicOptions()[index],
                          style: const TextStyle(
          ...
          Row(
            ...
            children: [
              ...
              if (showPreviousButton = musicqbank.musicQuestionNumber > 0)
                PreviousButton(
              ...
              NextButton(onTap: () {
                ...
                if (musicqbank.isLastMusicQuestion() == true) {
                  //to reset the quiz from the begining
                  musicqbank.resetMusicQuiz();
                  Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                      builder: ((context) =>
                          MusicScore(musicScore: musicScore)),
                    ),
                  );
                } else {
                  //go to next question
                  setState(() {
                    musicqbank.goToNextQuestion();
                  });
                }
